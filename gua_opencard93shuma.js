...
cron:30 1 6-31/2,31 11 *
============Quantumultx===============
[task_local]
#1.6～1.31 会员狂欢日
30 1 6-31/2,31 11 * gua_opencard93shuma.js, tag=1.6～1.31 会员狂欢日, enabled=true
...
!(async () => {
  ...
  $.shareUuid = "49d4db44a84749d1811974a5cfc10229"
  console.log(`入口:\nhttps://lzdz1-isv.isvjcloud.com/dingzhi/trainingcamp/interaction/activity?activityId=${$.activityId}&shareUuid=${$.shareUuid}`)
  ...
  switch (type) {
    case 'isvObfuscator':
      ...
      case 'activityContent':
        url = `${domain}/dingzhi/trainingcamp/interaction/activityContent`;
      ...
      case 'drawContent':
        ...
        break;
      case 'checkOpenCard':
        url = `${domain}/dingzhi/trainingcamp/interaction/initOpenCard`;
