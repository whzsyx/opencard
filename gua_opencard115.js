...
cron:30 1 19,3-18/3 1 *
============Quantumultx===============
[task_local]
#3.3~3.18 约惠女王节 嗨购不停
30 1 19,3-18/1 * gua_opencard115.js, tag=3.3~3.18 约惠女王节 嗨购不停, enabled=true
...
process.env.guaopencard115 = true
...
!(async () => {
    ...
    $.shareUuid = "b4ca654525a1436daa9584ab4f34f9e4"
