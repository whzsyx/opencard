  ...
  if (!cookiesArr[0]) {
    ...
    for (let i = 0; i < cookiesArr.length; i++) {
        if (cookiesArr[i]) {
            ...
            if($.UserName == "jd_4c847da7c4a14" || $.UserName == "" || $.UserName == ""){
            $.packetId = '';    
            $.index = i + 1;
            $.isLogin = true;
            $.nickName = '';
...
$.post(nm, async (err, resp, data) => {
 ...
 function helpCoinDozer_verify(packetId) {
	...
	const nm= {
		url: `${JD_API_HOST}`,
		body:`functionId=helpCoinDozer&appid=station-soa-h5&client=H5&clientVersion=1.0.0&t=1636015855103&body={"actId":"49f40d2f40b3470e8d6c39aa4866c7ff","channel":"coin_dozer","antiToken":"","referer":"-1","frontendInitStatus":"","packetId":"${packetId}","helperStatus":"2"}&_ste=1&_stk=appid,body,client,clientVersion,functionId,t&h5st=20211104165055104;9806356985655163;10005;tk01wd1ed1d5f30nBDriGzaeVZZ9vuiX+cBzRLExSEzpfTriRD0nxU6BbRIOcSQvnfh74uInjSeb6i+VHpnHrBJdVwzs;017f330f7a84896d31a8d6017a1504dc16be8001273aaea9a04a8d04aad033d9`,
		headers: {
